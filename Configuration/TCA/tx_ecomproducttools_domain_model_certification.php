...
return [
    'ctrl'      => [
        ...
        'label'          => 'title',
        'label_userFunc' => \S3b0\EcomProductTools\Utility\ModifyTCA::class . '->labelUserFuncEPTDomainModelCertification',
        'tstamp'         => 'tstamp',
        'crdate'         => 'crdate',
        'cruser_id'      => 'cruser_id',
        'dividers2tabs'  => true,
    ...
    'columns'   => [
        ...
        'type'             => [
            ...
            'config'    => [
                ...
                'items'             => [
                    [
                        "{$locallang}tx_ecomproducttools_domain_model_certification.type.I.0",
                        0,
                        'EXT:ecom_product_tools/Resources/Public/Icons/tx_ecomproducttools_domain_model_certification_certification.png'
                    ],
                    [
                        "{$locallang}tx_ecomproducttools_domain_model_certification.type.I.1",
                        1,
                        'EXT:ecom_product_tools/Resources/Public/Icons/tx_ecomproducttools_domain_model_certification_attestation.png'
                    ]
                ],
            ]
        ],
