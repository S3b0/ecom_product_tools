...
return [
	...
	'interface' => [ 'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, title, teaser, image, link_title, link_to_page, discontinued, excluded_in_download_center, product_categories, certifications, attestations' ],
	'types' => [
	...
	'palettes' => [
		'1' => [ 'showitem' => 'atex_zone, nec_division, discontinued, excluded_in_download_center, hidden', 'canNotCollapse' => TRUE ]
	],
	'columns' => [
		...
		'discontinued' => [
			...
			'config' => [
				'type' => 'check',
				'items' => [ [ $locallang . 'tx_ecomproducttools_domain_model_product.discontinued', 1 ] ],
				'default' => 0
			]
		],
		'excluded_in_download_center' => [
			...
			'config' => [
				'type' => 'check',
				'items' => [ [ $locallang . 'tx_ecomproducttools_domain_model_product.excluded_in_download_center', 1 ] ],
				'default' => 0
			]
		],
		'hidden' => [
